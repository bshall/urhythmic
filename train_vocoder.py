...
from urhythmic.dataset import MelDataset, LogMelSpectrogram
from urhythmic.utils import Metric, load_checkpoint, save_checkpoint
...
def train_model(rank, world_size, args):
    ...
    n_epochs = (STEPS if not args.finetune else FINETUNE_STEPS) // len(train_loader) + 1
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train or finetune the HiFiGAN vocoder."
    )
    parser.add_argument(
        "dataset_dir",
        metavar="dataset-dir",
